...
def verify_arbitrage_math(arbitrage):
    try:
            ...
            for currency, profit in profits.items():
                ...
                if currency == arbitrage.currency_z:
                    ...
                    if profit_rel < MIN_PROFIT:
                        ...
                        check_failed = True
            if arbitrage.profit_z_rel > 1:
                logger.error('Profit is unrealistically high: {}', arbitrage.profit_z_rel)
                check_failed = True
        ...
        logger.exception('Exception in verify_arbitrage_math(): {}', str(e))
